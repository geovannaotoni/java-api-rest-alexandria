...
public class AuthorController {
  ...
  public ResponseEntity<ResponseDTO<Author>> createAuthor(@RequestBody AuthorDTO authorDTO) {
    ...
    ResponseDTO<Author> responseDTO = new ResponseDTO<Author>("Autor criado com sucesso.", newAuthor);
  ...
  public ResponseEntity<ResponseDTO<Author>> updateAuthor(@PathVariable Long authorId, @RequestBody AuthorDTO authorDTO) {
    ...
    if (optionalAuthor.isEmpty()) {
      ResponseDTO<Author> responseDTO = new ResponseDTO<>(String.format("Autor com id %d não encontrado", authorId), null);
      return ResponseEntity.status(HttpStatus.NOT_FOUND).body(responseDTO);
    }

    ResponseDTO<Author> responseDTO = new ResponseDTO<>("Autor atualizado com sucesso.", optionalAuthor.get());
  ...
  public ResponseEntity<ResponseDTO<Author>> removeAuthorById(@PathVariable Long authorId) {
    ...
    ResponseDTO<Author> responseDTO = new ResponseDTO<>("Autor removido com sucesso", optionalAuthor.get());
    return ResponseEntity.ok(responseDTO);
  }
